...
urlpatterns = [
    ...
    re_path(r'^Predict_Insurance_Claim_Type/$', remoteuser.Predict_Insurance_Claim_Type, name="Predict_Insurance_Claim_Type"),
    ...
    re_path(r'^Find_Insurance_Claim_Prediction_Details_Ratio/$', serviceprovider.Find_Insurance_Claim_Prediction_Details_Ratio, name="Find_Insurance_Claim_Prediction_Details_Ratio"),
    re_path(r'^View_Insurance_Claim_Prediction_Details/$', serviceprovider.View_Insurance_Claim_Prediction_Details, name="View_Insurance_Claim_Prediction_Details"),
    re_path(r'^Train_Test_View_Results_Details/$', serviceprovider.Train_Test_View_Results_Details, name="Train_Test_View_Results_Details"),
