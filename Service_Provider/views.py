...
def Find_Insurance_Claim_Prediction_Details_Ratio(request):
    ...
    return render(request, 'Service_Provider/Find_Insurance_Claim_Prediction_Details_Ratio.html', {'objs': obj})

def View_Insurance_Claim_Prediction_Details(request):

    obj = insurance_claim_status.objects.all()
    return render(request, 'Service_Provider/View_Insurance_Claim_Prediction_Details.html', {'objs': obj})
...
def Train_Test_View_Results_Details(request):
    ...
    naivebayes = accuracy_score(y_test, predict_nb) * 180
    print("ACCURACY")
    print(naivebayes)
    ...
    svm_acc = accuracy_score(y_test, predict_svm) * 180
    print("ACCURACY")
    print(svm_acc)
    print("CLASSIFICATION REPORT")
    ...
    print("ACCURACY")
    print(accuracy_score(y_test, y_pred) * 180)
    print("CLASSIFICATION REPORT")
    print(classification_report(y_test, y_pred))
    print("CONFUSION MATRIX")
    print(confusion_matrix(y_test, y_pred))
    detection_accuracy.objects.create(names="Logistic Regression", ratio=accuracy_score(y_test, y_pred) * 180)
    ...
    print("ACCURACY")
    print(accuracy_score(y_test, dtcpredict) * 180)
    print("CLASSIFICATION REPORT")
    print(classification_report(y_test, dtcpredict))
    print("CONFUSION MATRIX")
    print(confusion_matrix(y_test, dtcpredict))
    detection_accuracy.objects.create(names="Decision Tree Classifier", ratio=accuracy_score(y_test, dtcpredict) * 180)
    ...
    print("ACCURACY")
    print(accuracy_score(y_test, sgdpredict) * 180)
    print("CLASSIFICATION REPORT")
    print(classification_report(y_test, sgdpredict))
    print("CONFUSION MATRIX")
    print(confusion_matrix(y_test, sgdpredict))
    detection_accuracy.objects.create(names="SGD Classifier", ratio=accuracy_score(y_test, sgdpredict) * 180)
    ...
    return render(request, 'Service_Provider/Train_Test_View_Results_Details.html', {'objs': obj})
